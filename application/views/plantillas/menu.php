            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-file-text fa-fw"></i> Estado de Cuentas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('estado_cuentas/realizar_pago') ?>">Realizar Pago</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('estado_cuentas/lista') ?>">Lista Clientes</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('clientes/crear') ?>">Crear Cliente</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('clientes/lista') ?>">Lista Clientes</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo site_url('configuracion/listaLavados') ?>">Lista Lavados o Teñidos</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('configuracion/listaAplicaciones') ?>">Lista Aplicaciones</a>
                                </li>
                            </ul>
                        </li>
                        <!-- <li>
