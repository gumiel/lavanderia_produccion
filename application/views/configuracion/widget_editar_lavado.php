                <!-- Modal -->
                <!-- Modal -->
                <div class="modal fade" id="myModalLavEdit" tabindex="-1" role="dialog" aria-labelledby="myModalApliLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form id="formeditarLav" name="formeditarLav" class="form-horizontal fixed-formulario" action="<?php echo site_url('configuracion/editarLavado'); ?>" method="POST">
                        ...
                        <div class="modal-footer">
                          <input type="hidden" name="id_lavadosE" id="id_lavadosE" value="">
